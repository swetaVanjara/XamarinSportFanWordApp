...
namespace Fanword.Api
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext<ApplicationUserManager>(ApplicationUserManager.CreateOwinVersionWithUniqueEmail);
            app.CreatePerOwinContext<ApplicationRoleManager>(ApplicationRoleManager.CreateOwin);
            app.CreatePerOwinContext<ApplicationSignInManager>(ApplicationSignInManager.CreateOwin);
