(function () {
    ...
    function userAdminsController($scope, $http, $state, moment) {
        $scope.vm = {};
        ...
        function setupControls() {
            $scope.teamAdminOptions = {
                ...
                toolbar: [
                    {
                        template: "<input type='text' class='k-textbox agilx-name-lg pull-left' ng-model='vm.teamSearchText' ng-change='onTeamSearchChange()' style='width:300px'  placeholder='Search by name' />" +
            ...
            $scope.schoolAdminOptions = {
                ...
                toolbar: [
                    {
                        template: "<input type='text' class='k-textbox agilx-name-lg pull-left' ng-model='vm.schoolSearchText' ng-change='onSchoolSearchChange()' style='width:300px'  placeholder='Search by name' />" +
                            "<button type='button' class='btn btn-primary pull-right' ng-click='addNew()'>Add New</button>"
                    }
                ],
                columns: [
        ...
        ;
        $scope.onTeamSearchChange = function () {
            var filters = [];
        ...
        $scope.onSchoolSearchChange = function () {
            var filters = [];
        ...
        $scope.reinstate = function (kendoData) {
            swal({
                title: 'Are you sure?',
...
//# sourceMappingURL=App.UserAdmins.Controller.js.map