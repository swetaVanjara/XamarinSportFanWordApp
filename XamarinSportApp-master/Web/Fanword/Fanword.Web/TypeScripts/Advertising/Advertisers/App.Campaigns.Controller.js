(function () {
    ...
    function campaignsController($scope, $http, $state) {
        $scope.searchText = "";
        function setupControls() {
            $scope.campaignOptions = {
                ...
                toolbar: [
                    {
                        template: "<input type='text' class='k-textbox agilx-name-lg pull-left' ng-model='searchText' ng-change='onSearchChange()' style='width:300px'  placeholder='Search by title or profile' />" +
...
//# sourceMappingURL=App.Campaigns.Controller.js.map