(function () {
    ...
    function campaignController($scope, $http, $state, $timeout) {
        ...
        function saveCampaign() {
            if ($scope.campaign.id == 'NEW') {
                $http.post('/api/Campaigns/', $scope.campaign).then(function (promise) {
...
//# sourceMappingURL=App.Campaign.Controller.js.map