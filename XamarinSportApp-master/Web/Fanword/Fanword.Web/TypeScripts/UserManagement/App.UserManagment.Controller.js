(function () {
    ...
    function userManagementController($scope, $http, $state, moment) {
        ...
        function setupControls() {
            $scope.userGridOptions = {
                ...
                toolbar: [
                    {
                        template: "<input type='text' class='k-textbox agilx-name-lg pull-left' ng-model='searchText' ng-change='onSearchChange()' style='width:300px'  placeholder='Search by name or email' />" +
        ...
        $scope.deleteUser = function (kendoData) {
            swal({
                title: 'Are you sure?',
...
//# sourceMappingURL=App.UserManagment.Controller.js.map